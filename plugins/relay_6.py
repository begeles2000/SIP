...
def load_params():
    ...
    try:
        ...
        with open('./data/relay_6.json', 'w') as f:
            json.dump(params, f)
    return params
...
class settings(ProtectedPage):
    ...
    def GET(self):
        with open('./data/relay_6.json', 'r') as f:  # Read the settings from file
            params = json.load(f)
        return template_render.relay_6(params)
...
class update(ProtectedPage):
    """Save user input to relay_6.json file"""
    ...
    def GET(self):
        ...
        if changed:
           init_pins();
           with open('./data/relay_6.json', 'w') as f:  # write the settings to file
              json.dump(params, f)
        raise web.seeother('/')
